            ...
            if command.start_with?('upload')
              ...
              if has_llm_params
                ...
                unless command_generated.nil? || command_generated.empty?
                  while true
                    print_message('Do you want to execute or [k]eep the generated command/s? [y/k/N] ', TYPE_WARNING, true, $logger)
                    ...
                    when /k/i
                      ...
                      command = ""
                      print_message('LLM Command kept in history: Access to IT using ↑ arrow to the stored command.', TYPE_INFO, true, $logger)
                      break
                    when /n/i, ''
